...
#[Route('/notificacion/read/creador/fecha', name: 'notifiacion_read_creador_fecha', methods: ['GET'])]
class ReadNotificacionByFechaCreadorController extends AbstractController
{
    #[OA\Tag(
        name: 'Notificaciones',
    ...
    #[OA\Get(
        path: '/api/notificacion/read/creador/fecha',
        description: 'Recupera una lista de notificaciones creadas por el  usuario actualmente autenticado, filtradas por la fecha proporcionada en el cuerpo de la solicitud (formato YYYY-MM-DD).',
    ...
    public function __invoke(Request $request, NotificacionesReadByFechaCreadorService $readService):JsonResponse
    {
