...
#[Route('/admin/notificacion/read/usuario/fecha', name: 'read_notificaciones_usuario_by_fecha_admin', methods: ['GET'])]
class ReadNotificacionesByFechaUsuarioAdminController extends AbstractController
{
    #[OA\Tag(
        name: 'Notificaciones',
    ...
    #[OA\Get(
        path: '/api/admin/notificacion/read/usuario/fecha',
        description: 'Recupera una lista de notificaciones dirigidas al usuario proprcionado filtradas por la fecha proporcionada en el cuerpo de la solicitud (formato YYYY-MM-DD).',
        summary: 'Obtener notificaciones recibidas por el usuario proprocionado en una fecha específica',
        parameters: [
    ...
    public function __invoke(Request $request, NotificacionesReadByFechaUsuarioAdminService $readService): JsonResponse
    {
