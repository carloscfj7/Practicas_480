...
#[Route('/admin/proyecto/read/consultor', name: 'readByConsultor_proyecto', methods: 'GET')]
class ProyectoReadByConsultorController extends AbstractController
{
    #[OA\Get(
        path: "/api/admin/proyecto/read/consultor",
        description: "Obtiene la lista de proyectos asignados a un consultor específico. Accesible solo por administradores.",
        summary: "Leer proyectos por consultor (Admin)",
        tags: ["Proyecto"],
        parameters: [
            new OA\Parameter(
                name: "email",
                description: "email del consultor cuyos proyectos se quieren consultar",
                in: "query",
                required: true,
                schema: new OA\Schema(type: "string", example: "consultor@consultor.com")
            ),
        ],
        responses: [
            new OA\Response(
    ...
    public function __invoke(ProyectoReadByConsultorService $readService, Request $request):JsonResponse
    {
