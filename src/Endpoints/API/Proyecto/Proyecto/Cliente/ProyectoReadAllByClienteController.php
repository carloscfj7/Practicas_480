...
#[Route('/proyecto/read/cliente/all', name: 'read_proyectos_cliente', methods: 'GET')]
class ProyectoReadAllByClienteController extends AbstractController
{
    #[OA\Get(
        path: "/api/proyecto/read/cliente/all",
        description: "Obtiene la lista de proyectos asociados al cliente autenticado.",
        summary: "Leer todos los proyectos del cliente",
        tags: ["Proyecto"],
        responses: [
            new OA\Response(
                response: 200,
    ...
    public function __invoke(ProyectoReadAllClienteService $readService):JsonResponse
    {
