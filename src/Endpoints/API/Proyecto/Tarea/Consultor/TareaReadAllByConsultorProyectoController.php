...
#[Route('/tarea/read/consultor/all/proyecto', name: 'readProyecto_tarea_consultor', methods: ['GET'])]
class TareaReadAllByConsultorProyectoController extends AbstractController
{
    #[OA\Get(
        path: "/api/tarea/read/consultor/all/proyecto",
        description: "Obtiene todas las tareas asignadas al consultor para un proyecto específico.",
        summary: "Leer todas las tareas del consultor por proyecto",
        tags: ["Tarea"],
        parameters: [
            new OA\Parameter(
                name: "proyecto",
        ...
        responses: [
            new OA\Response(
                response: 200,
                description: "Tareas obtenidas exitosamente para el proyecto especificado",
    ...
    public function __invoke(TareaReadByProyectoConsultorService $readService, Request $request): JsonResponse
    {
