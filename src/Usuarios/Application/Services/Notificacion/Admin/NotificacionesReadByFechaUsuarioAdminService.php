...
class NotificacionesReadByFechaUsuarioAdminService
{
    ...
    public function __invoke(array $data): JsonResponse
    {
        ...
        if ($notificaciones === []) {
            return new JsonResponse(['message' => 'No hay ninguna notificacion recibida en la fecha proporcionada por el usuario ' . $usuario->getEmail()->value()], Response::HTTP_OK);
        }
