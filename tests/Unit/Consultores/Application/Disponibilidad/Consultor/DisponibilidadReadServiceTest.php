...
class DisponibilidadReadServiceTest  extends Unit
{
    ...
    public function testShouldReadDisponibilidadSuccessfully(): void
    {
        ...
        $service = new DisponibilidadReadService($this->disponibilidadRepository, $this->consultorRepository, $this->disponibilidadDto);
        $response = $service($usuario, $data);

        $this->assertEquals($this->disponibilidadDto, $response);
    }
