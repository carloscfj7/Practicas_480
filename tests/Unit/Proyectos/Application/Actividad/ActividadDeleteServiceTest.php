...
class ActividadDeleteServiceTest extends Unit
{
    ...
    public function testShouldReadActividadSuccessfully(): void
    {
        ...
        $service = new ActividadDeleteService($this->actividadRepository, $this->proyectoRepository, $this->consultorRepository);
        ...
        $this->assertEquals("Actividad eliminada correctamente", $content['message']);
    }
