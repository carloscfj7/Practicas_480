...
class ActividadUpdateByProyectoAndNombreServiceTest extends Unit
{
    ...
    public function testShouldUpdateAllActividadSuccessfully(): void
    {
        ...
        $service = new ActividadUpdateByProyectoAndNombreService($this->actividadRepository, $this->proyectoRepository);
